...
{
    public partial class Your_Cars : UserControl
    {
        string Seller_UserName;
        
        String MYCON = "Data Source=.;Initial Catalog=Car_Database_2020;Integrated Security=True";
        public Your_Cars(string U)
        {
            
            InitializeComponent();
            
            Seller_UserName = U;
            string sql = "SELECT Product_code,Car_Name,Model FROM Cars where Seller_username='"+Seller_UserName+"'";
        ...
        private void Your_Cars_Load(object sender, EventArgs e)
        {
        ...
        private void MetroButton1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                con.Open();
                string PNAME = "UPDATE_CAR_INFORMATION";
                SqlCommand cmd1 = new SqlCommand(PNAME, con);
                cmd1.CommandType = CommandType.StoredProcedure;
                cmd1.Parameters.Add("@P", SqlDbType.NVarChar).Value = bunifuMaterialTextbox3.Text;
                cmd1.Parameters.Add("@A", SqlDbType.NVarChar).Value = metroComboBox2.Text;
                cmd1.Parameters.Add("@PC", SqlDbType.NVarChar).Value = bunifuMaterialTextbox1.Text;
        ...
        private void MetroGrid1_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            string q1 = "select price,Car_Image,Car_Engine,Mileage,Tank_Capacity,Color from Cars where Product_code = '" + pro + "'";
