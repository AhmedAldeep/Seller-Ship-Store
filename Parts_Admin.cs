...
{
    public partial class Parts_Admin : UserControl
    {
        String MYCON = "Data Source=.;Initial Catalog=Car_Database_2020;Integrated Security=True";
        public Parts_Admin()
        {
            InitializeComponent();
            string sql = "SELECT Product_code,Part_Name,Price FROM Car_Part ";
        ...
        private void MetroButton1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                MetroFramework.MetroMessageBox.Show(this, "\n\n\t  Car Part Information has Been Edited");
        ...
        private void MetroGrid1_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (d.Read())
            {
                ...
                bunifuMaterialTextbox5.Text = d[2].ToString();
                path = d[1].ToString();
